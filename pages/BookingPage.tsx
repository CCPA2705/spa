                    ...
                    <div className="p-5 space-y-4">
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <select 
                                className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-spa-500 outline-none font-medium ${
                                    formData.status === BookingStatus.CONFIRMED ? 'text-blue-700 bg-blue-50' :
